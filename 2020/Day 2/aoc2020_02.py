...
for line in input:
    ...
    part1 = part1 + is_valid_password_part1(int(m.group(1)), int(m.group(2)), m.group(3), m.group(4))
    part2 = part2 + is_valid_password_part2(int(m.group(1)), int(m.group(2)), m.group(3), m.group(4))
